...
export async function generateMetadata() {
  ...
  return {
    ...
    keywords: [
      ...
      "Edenstone Group", "Edenstone IP", "Lionara", "Lionara city", "Spore pathogen story",
      // Genre & Narrative Keywords
      "Speculative fiction", "Dystopian sci-fi", "Biopunk narrative", "Singaporean sci-fi", "Singapore speculative fiction",
      "Post-apocalyptic story", "Cyberpunk city stories", "Sci-fi pathogen outbreak", "Mutation fiction", "Zombie apocalypse",
      // Character & Plot Keywords
      "Disillusioned soldier character", "Rogue medic story", "Infected brother narrative", "Mutant abilities sci-fi",
      "Human evolution fiction", "Resistance vs regime story", "Iron-fisted regime dystopia",
      ...
      "Scalable intellectual property", "IP development platform",
      "De-risking IP development", "Community co-creation", "Franchise valuation levers", "Original IP valuation",
      ...
      "The future will be chosen", "Reimagining identity fiction", "Evolution vs Resistance", "Embracing evolution narrative",
      "Identity in speculative fiction", "Infection abilities",
      // Long-Tail Keywords
      "What is the Spore Fall universe?", "Story about pathogen that causes evolution", "Multi-platform sci-fi universe Singapore",
      "Interactive stories like Spore Fall", "Edenstone Group projects", "Futuristic city name Lionara", "Sci-fi stories about evolution"
    ],
    openGraph: {
      title,
      description,
