          ...
          <div className="flex flex-col items-center">
            ...
            >
              ...
              <motion.h1
                ...
                className="max-w-[60%] mx-auto text-2xl md:text-5xl font-subheading font-bold tracking-widest mb-6 uppercase bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/40 leading-normal"
              >
                {title}
              </motion.h1>
