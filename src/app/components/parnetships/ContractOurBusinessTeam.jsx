export const ContractOurBusinessTeam = () => {
  return (
    <section className="py-24 px-6 border-t border-white/5">
      <div className="max-w-7xl mx-auto text-center border-2 border-primary/20 rounded-3xl p-16 bg-primary/5 backdrop-blur-sm">
        <p className="text-[10px] md:text-[18px] tracking-normal text-gray-400 mb-8">
        ...
        <h2 className="font-subheading  text-3xl md:text-5xl text-white mb-12 tracking-wider">
